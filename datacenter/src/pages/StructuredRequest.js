        ...
        <main className="bg-gradient-to-b from-blue-50 to-white">
            <section>
                <div className="mx-auto max-w-7xl pt-8 pb-4">
                    <h1 className="font-bold text-2xl mb-2">Structured Data Application</h1>
                    <p className="text-lg">
            ...
            <section>
                <div className="mx-auto max-w-7xl px-5 py-6 bg-white rounded-lg shadow-sm border border-gray-200 space-y-3">
                    <h1 className="font-semibold text-xl">Schema List</h1>
                    <div className="overflow-x-auto">
                        <table className="min-w-max table-fixed divide-y divide-gray-200">
                            <thead>
                                <tr className="text-left text-sm font-medium text-gray-700 uppercase tracking-wider font-medium">
                                    <th className="w-64">Schema Name</th>
                                    <th className="w-96">description</th>
                                    <th className="w-40">creator</th>
                                    <th className="w-24">patients</th>
                                    <th className="w-40">tables</th>
                            ...
                            <tbody>
                                {currentCohorts.length > 0 ? (
                                    currentCohorts.map((schema) => (
                                        <tr
                                            key={schema.id}
                                            className="border-b border-gray-200 text-sm text-gray-800 font-normal"
                                        >
                                            <td className="py-4">
                                            ...
                                            <td>{schema.patient_count}</td>
                                            <td>{schema.tables?.length} tables</td>
                                            <td>
